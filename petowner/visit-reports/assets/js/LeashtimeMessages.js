(function (namespace, $) {
	...
	p._initStateToastr = function () {
		var o = this;
    $('#mood-happy').on('click', function (e) {
			o._toastrStateConfig();
			toastr.info('Happy Pet', '');
		});
		$('#mood-sad').on('click', function (e) {
			o._toastrStateConfig();
			toastr.warning('A Little Sad', '');
		});
		$('#mood-shy').on('click', function (e) {
			o._toastrStateConfig();
			toastr.error('Shy Today', '');
		});
		$('#mood-sick').on('click', function (e) {
			o._toastrStateConfig();
			toastr.success('Sick Pet', '');
		});
		$('#mood-hungry').on('click', function (e) {
			o._toastrStateConfig();
			toastr.info('Food Refill', '');
		});
		$('#mood-litterbox').on('click', function (e) {
			o._toastrStateConfig();
			toastr.warning('Litterbox', '');
		});
		$('#mood-poo').on('click', function (e) {
			o._toastrStateConfig();
			toastr.error('Poo', '');
		});
		$('#mood-pee').on('click', function (e) {
			o._toastrStateConfig();
			toastr.success('Pee', '');
		});
	};
